...
class File:
    ...
    def _get_content(self) -> bytes | None:
        ...
        # 2. Use loaded content...
        if self.content:
            output = self.content

        # 3. Load filesystem content...
        else:
            load_path = None
    ...
    def _decode_content(content: str | bytes | None) -> bytes | None:
        ...
        # 1. Prepare decoded content...
        decoded_content = None

        # 2. Keep bytes content...
        if isinstance(content, bytes):
            decoded_content = content

        # 3. Decode text content...
        elif isinstance(content, str):
            decoded_content = base64.b64decode(content)

        # 4. Return decoded content...
